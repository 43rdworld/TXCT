...
//ECHO "PageName: ".$_SERVER['HTTP_REFERER']."<br>";
        if(strtolower(returnPageName($_SERVER['HTTP_REFERER'])) == 'parentpermission.php') {
            ...
            if (strtolower($_POST["submitRegistration"]) == 'submitparentguardianregistration') {
                ...
                if (returnRegistrationStatus ($dbh,'EXEC sp_GetUserID :tableName,:formSecret','id','tbl_TCT_PermissionResponsibility',$_POST['formSecret']) != 'zzz') {
                    setVars('formSecret:str,permGirlFName:str,permGirlLName:str,permGSTroop:str,permSU:int,permPackages:int,permMyEmail:str,permLeadEmail:str,permTCMEmail:str,perm1:str,perm2:str,perm3:str,perm4:str,perm5:str,permCClub:bit,permCC1:str,permCC2:str,permCC3:str,permCC4:str,permParentFName:str,permParentLName:str,permIDType:str,permID:str,permHomeAddress:str,permCity:str,permZip:int,permHomePhone:str,permCellPhone:str,permOption:bit,permGradeLevel:str,permSignedName:str', 0, 1, 'Parent Permission Registration Form');
                    $dbFields = array("Form Secret: ".$formSecret,"Girl FName: ".$permGirlFName,"Girl LName: ".$permGirlLName,"Service Unit: ".$permSU,"Troop Number: ".$permGSTroop,"Packages: ".$permPackages,"Sub Email: ".$permMyEmail,"Leader Email: ".$permLeadEmail,"TCM Email: ".$permTCMEmail,"Perm 1: ".$perm1,"Perm 2: ".$perm2,"Perm 3: ".$perm3,"Perm 4: ".$perm4,"Perm 5: ".$perm5,"Perm CC: ".$permCClub,"Perm 6: ".$permCC1,"Perm 7: ".$permCC2,"Perm 8: ".$permCC3,"Perm 9: ".$permCC4,"Parent FName: ".$permParentFName,"Parent LName: ".$permParentLName,"ID Type: ".$permIDType,"ID Number: ".$permID,"Address: ".$permHomeAddress,"City: ".$permCity,"Zip: ".$permZip,"Phone: ".$permHomePhone,"Cell: ".$permCellPhone,"Cash Option: ".$permOption,"Grade Level: ".$permGradLevel,"Signature: ".$permSignedName);
