    ...
    $("#theForm").validate({
		...
		rules: {
            ...
            orderS: 	{
                ...
                number: true,
                remote:     {url: "includes/i_SUCCShirtOrderValidate_SS.php", async: false}
            },
            orderM: 	    {
                require_from_group: [1, ".tshirtOrderGroup"],
                number: true,
        ...
        errorPlacement: function(error, element) {
            ...
            } else if(element.attr("name") === "orderState") {
                error.appendTo("#orderStateError");
            ...
            } else if(element.attr("name") === "billingEmail2") {
                error.appendTo("#billingEmail2Error");
        ...
        messages: {
            serviceUnit:	{
             ...
             orderS:  {
                ...
                remote:     "* Enter a t-shirt quantityx"
            },
            orderM:  {
                require_from_group:   "* Enter a t-shirt quantity",
                remote:     "* Enter a t-shirt quantityy"
            },
            orderL:  {
                require_from_group:   "* Enter a t-shirt quantity",
