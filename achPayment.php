<?php
    header('Location: https://www.texascookietime.org/forms/tct2015/achPayment.php');
    exit();
    ...
    require("includes/i_ACHSettings.php");
            ...
            <form name="theForm" id="theForm" method="post" action="parentPermissionConfirm.php" autocomplete="off">
                <div>
                    ...
                    <div class="container showWhite" style="position:relative;">
                        ...
                        <div class="span-24"><p>&#32;</p></div>
                        <div class="span-2"><p>&#32;</p></div>
                        <div class="span-20" style="font-size:1.3em;text-align:center;"><br><br><br>We know you can't wait to get started but we're hanging some new paintings and putting out the fine china so things looks their best.<br><br>The ACH Payment form will be available February 5<sup>th</sup>, 2015.<br><br><br></div>
                        <div class="span-2 last"><p>&#32;</p></div>
                        <div class="span-24"><p>&nbsp;</p></div>
                        <div class="span-2"><p>&#32;</p></div>
                        <div class="span-20" style="background-color:green;height:6px">&#32;</div>
